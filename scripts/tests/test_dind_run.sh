...
unset OPIK_PREFLIGHT_STRICT OPIK_PREFLIGHT_CONNECT_TIMEOUT OPIK_PREFLIGHT_MAX_TIME
...
OPIK_URL= \
OPIK_PREFLIGHT_STRICT=1 \
OPIK_PREFLIGHT_CONNECT_TIMEOUT=2 \
OPIK_PREFLIGHT_MAX_TIME=7 \
MIN_TEST=1 \
