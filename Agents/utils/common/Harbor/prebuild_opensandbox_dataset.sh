...
HARBOR_OPENSANDBOX_BASE_IMAGE_REGISTRY="${HARBOR_OPENSANDBOX_BASE_IMAGE_REGISTRY:-}"
...
HARBOR_OPENSANDBOX_PUB_HOSTED_URL="${HARBOR_OPENSANDBOX_PUB_HOSTED_URL:-}"
HARBOR_OPENSANDBOX_JULIA_PKG_SERVER="${HARBOR_OPENSANDBOX_JULIA_PKG_SERVER:-}"
...
export HARBOR_OPENSANDBOX_BASE_IMAGE_REGISTRY
