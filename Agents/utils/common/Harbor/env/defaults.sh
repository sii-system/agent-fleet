...
# Pi analysis and summary use the OpenAI gateway, as run_fleet.sh summary does.
# Agent-specific Anthropic proxy tokens can be placeholders, not provider keys.
...
HARBOR_SUMMARY_ENABLED="${HARBOR_SUMMARY_ENABLED:-1}"
