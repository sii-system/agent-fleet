...
# shellcheck source=agent_config.sh
source "$SCRIPT_DIR/env/agent_config.sh"
# shellcheck source=sandbox_config.sh
...
export SCRIPT_DIR REPO_ROOT AGENTS_DIR TASKS_DIR HARBOR_CLAUDE_CODE_DIR HARBOR_OPENCODE_DIR HARBOR_PI_DIR HARBOR_DSH_DIR WORKSPACE_DIR RUN_ID TOTAL_WORKERS MODEL AGENT
...
export DSH_SDK_MINIMAL_SOURCE_SHA
...
export DSH_CONTEXT_WINDOW DSH_TEMPERATURE DSH_TOP_P
...
export HARBOR_CC_WEB_MCP_ENABLED HARBOR_CC_WEB_MCP_SOURCE HARBOR_CC_WEB_MCP_MOUNT_PATH
