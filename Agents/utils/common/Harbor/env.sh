...
OPIK_PREFLIGHT_STRICT="${OPIK_PREFLIGHT_STRICT:-0}"
OPIK_PREFLIGHT_CONNECT_TIMEOUT="${OPIK_PREFLIGHT_CONNECT_TIMEOUT:-5}"
OPIK_PREFLIGHT_MAX_TIME="${OPIK_PREFLIGHT_MAX_TIME:-15}"
# Internal task marker shared with the parent worker; not operator-configurable.
OPIK_PREFLIGHT_FAILURE_MARKER=".opik-preflight-disabled"
