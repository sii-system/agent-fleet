...
export OPIK_REPO_DIR COMPOSE_DIR HARBOR_SKIP_DOCKERHUB_PREFLIGHT HARBOR_DOCKERHUB_CHECK_TIMEOUT HARBOR_DOCKERHUB_PREFLIGHT_STRICT SMITH_GENERATE_IF_MISSING SMITH_ADAPTER_DIR FIX_GIT_IMAGE_NAME FIX_GIT_WARM_LABEL
