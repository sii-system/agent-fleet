...
export SCRIPT_DIR REPO_ROOT AGENTS_DIR TASKS_DIR HARBOR_CLAUDE_CODE_DIR HARBOR_OPENCODE_DIR HARBOR_PI_DIR WORKSPACE_DIR RUN_ID TOTAL_WORKERS MODEL AGENT
...
export HARBOR_LIMIT HARBOR_N_ATTEMPTS HARBOR_AGENT_IMPORT_PATH HARBOR_MODEL HARBOR_INCLUDE_TASKS HARBOR_DRY_RUN MIN_TEST MIN_TEST_INCLUDE_TASK
